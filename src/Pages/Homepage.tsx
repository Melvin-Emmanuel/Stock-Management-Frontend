...
const Homepage = () => {
  ...
  const islogin = useSelector((state:any) => state.LoginModal);
    ...
    <div className="h-screen flex flex-col w-full bg-[#050b68] justify-center gap-[20px]">
      ...
      <div className="flex-1 overflow-y-clip pt-1 mt-[80px] ml-auto flex w-[90%]">
        <div className="h-[90%] w-[50%] flex flex-col gap-8">
          <h1 className="text-4xl w-[50%] font-extrabold">
          ...
          <p className="text-2xl w-[70%]">
            ...
            real time and integrated to make it easier to manage your business
          </p>
          <div className="p-1 w-[150px] border border-l-white cursor-pointer hover:bg-slate-600 hover">
            1 Month Free Trial
          </div>
