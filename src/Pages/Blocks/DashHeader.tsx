...
import { changeNotification, changeApps } from '../../Services/Reducers';
      ...
      <div className="flex flex-wrap justify-between items-center">
        <div className="flex justify-start items-center">
          <button
            ...
            className="p-2 mr-2 text-gray-600  bg-bgCard rounded-lg cursor-pointer md:hidden hover:text-gray-900 hover:bg-gray-100 focus:bg-gray-100 dark:focus:bg-gray-700 focus:ring-2 focus:ring-gray-100 dark:focus:ring-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white"
          >
            <svg
              aria-hidden="true"
              className="w-6 h-6"
          ...
          <a
            href=""
            className="flex items-center justify-between mr-4 bg-inherit"
          >
        ...
        <div className="flex  items-center lg:order-2 lg:gap-10">
          <button
            type="button"
            data-drawer-toggle="drawer-navigation"
            aria-controls="drawer-navigation"
          ...
          {notification ? (
            <Notifications
              ...
              className="fixed top-0 right-20 overflow-hidden hidden z-50 my-4 max-w-sm text-base list-none bg-white rounded divide-y divide-gray-100 shadow-lg dark:divide-gray-600 dark:bg-gray-700 rounded-xl"
              id="notification-dropdown"
            >
              <div className=" py-2 px-4 text-base font-medium text-center text-gray-700 bg-gray-50 dark:bg-gray-600 dark:text-gray-300 flex justify-around">
                <p>Notifications</p>{" "}
                <p
          ...
          {apps ? (
            <ShortCut
              ...
              className=" overflow-hidden fixed top-9 right-20 z-50 my-4 max-w-sm text-base list-none bg-white rounded divide-y divide-gray-100 shadow-lg dark:bg-gray-700 dark:divide-gray-600 rounded-xl"
              id="apps-dropdown"
            >
