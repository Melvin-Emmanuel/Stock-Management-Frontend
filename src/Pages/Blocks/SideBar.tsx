...
import { ChangeCategory, ChangeProducts, ChangeSales } from '../../Services/Reducers'
const Sidebar = styled.div``
const CatTab = styled.li``
        ...
        <ul className="space-y-2">
          ...
          <ProductTab>
            ...
            >
              <svg
                aria-hidden="true"
                className="mx-auto mb-1 w-7 h-7 text-[#494e58] group-hover:text-gray-500 dark:text-gray-400 dark:group-hover:text-gray-400"
                fill="currentColor"
                viewBox="0 0 20 20"
                xmlns="http://www.w3.org/2000/svg"
              >
